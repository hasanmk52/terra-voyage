    ...
    DRAFT: [
      {
        ...
        description: "Trip is ready with itinerary",
      },
      {
    ...
    PLANNED: [
      {
        ...
        label: "Start Trip",
        description: "Trip is now active",
      },
      {
    ...
    COMPLETED: [
      {
        status: "ACTIVE" as TripStatus,
        label: "Reactivate",
        description: "Reactivate this trip",
      },
    ],
    CANCELLED: [
      {
      ...
      {
        status: "PLANNED" as TripStatus,
        label: "Restore to Planned",
        description: "Restore planned trip",
      },
    ],
  };
