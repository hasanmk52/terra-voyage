...
import { Star, Quote, CheckCircle, Users, MapPin, Clock, Award } from "lucide-react"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Your data is protected</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Best Travel AI 2024</div>
                </div>
              </div>
            </div>
          </div>
