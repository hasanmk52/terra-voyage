      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Have questions about Terra Voyage? We'd love to hear from you. 
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@terravoyage.com</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Travel Street<br />San Francisco, CA 94105</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Monday - Friday: 9am - 6pm PST<br />Weekend: 10am - 4pm PST</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    alert("Thank you for your message! This is a demo - your message wasn't actually sent.")
                  }}
                >
                  Send Message
                </button>
